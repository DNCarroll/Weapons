...
//.Blunt
{
    ...
    {
        //internal static void setFirstFromDataReader<T>(SqlCommand command, T newObject) where T : class, new()
        //{
        ...
        //internal static void setValuesFromReader<T>(T obj, IDataReader reader)
        //where T : class
        //{
        //    //reader.FieldCount
