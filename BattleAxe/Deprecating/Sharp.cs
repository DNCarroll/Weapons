...
//.Sharp
{
    internal static class Sharp
    {
        ...
        //    {
        //        var reference = Extensions.structureFields.Where(i => i.Item1.CommandText == command.CommandText && i.Item1.Connection.ConnectionString == command.Connection.ConnectionString && i.Item2 == parameter.TypeName).ToList();
        ...
        //internal static void setFirstFromDataReader(SqlCommand command, IBattleAxe newObject)
        //{
        ...
        //internal static void setValuesFromReader(IBattleAxe obj, IDataReader reader)
        //{
        //    //reader.FieldCount
