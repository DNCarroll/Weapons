...
namespace BattleAxe
{
    public static class UpdateExtensions
    {
        ...
        public static List<Dynamic> Update(this SqlCommand command, List<Dynamic> objs)
        {
            return command.Update<Dynamic>(objs);
        }
        /// <summary>
        ...
        public static void Update(this List<Dynamic> objs, SqlCommand command)
        {
            Update<Dynamic>(command, objs);
        }
